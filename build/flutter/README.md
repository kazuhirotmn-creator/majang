...
* `pythonproject` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `PythonProject` - executable or bundle name on disk.
* `PythonProject` - display name shown in window titles and about app dialogs.
